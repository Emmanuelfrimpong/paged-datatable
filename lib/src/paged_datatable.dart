                    ...
                    child: Row(
                      children: [
                        SizedBox(
                          ...
                          child: Column(
                            children: [
                              _PagedDataTableHeaderRow<TKey, TResultId,
                                  TResult>(rowsSelectable, width),
                              Divider(
                                  height: 0, color: localTheme.dividerColor),
                              Expanded(
                                child: _PagedDataTableRows<TKey, TResultId,
                                        TResult>(
                                    rowsSelectable,
                                    customRowBuilder ??
